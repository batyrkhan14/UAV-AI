...
public class AeroplaneControlSurfaceAnimator : MonoBehaviour
{
	...
	// The smoothing applied to the movement of control surfaces.
	[SerializeField] private ControlSurface[] m_ControlSurfaces;
	// Collection of control surfaces.
	...
	public class ControlSurface // Control surfaces represent the different flaps of the aeroplane.
	{
		...
		// The transform of the control surface.
		public float amount;
		// The amount by which they can rotate.
		public Type type;
		// The type of control surface.

		[HideInInspector] public Quaternion originalLocalRotation;
		// The rotation of the surface at the start.
	}
}
